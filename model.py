...
class NnqlmCnnBasedLstm(nn.Module):
    def __init__(self, vocab, embedding_dim, batch_size, q_len, a_len, word_dim, num_layer, num_filter, conv_ks,
                 padding, dropout_lstm, dropout_linear, mode='max'):
        super().__init__()
        ...
        self.cbl = CnnBasedLstm(num_filter, num_layer, conv_ks, padding, dropout_lstm)
